...
GUIDELINES_PROMPT = (
    ...
    "5. PROGRAMS: Name of any programs, activities, initiatives, campaigns, or pilots related to addiction treatment.\n"
    "6. IMPACT: Describe the impact or outcomes of the program.\n"
    "\n"
    "Output Format:\n"
    "{{'PERSON': [list of entities present], 'DATE': [list of entities present], 'LOC': [list of entities present], 'ORG': [list of entities present], 'PROGRAMS': [list of entities present], 'IMPACT': [list of entities present]}}\n"
    "If no entities are presented in any categories keep it None\n"
    "\n"
    "Examples:\n"
    "\n"
    "1. Sentence: Mr. Jacob lives in Madrid since 12th January 2015.\n"
    "Output: {{'PERSON': ['Mr. Jacob'], 'DATE': ['12th January 2015'], 'LOC': ['Madrid'], 'ORG': ['None'], 'PROGRAMS': ['None'], 'IMPACT': ['None']}}\n"
    "\n"
    ...
    "Output: {{'PERSON': ['Mr. Rajeev Mishra', 'Sunita Roy'], 'DATE': ['24/03/1998'], 'LOC': ['None'], 'ORG': ['Doctors Without Borders'], 'PROGRAMS': ['None'], 'IMPACT': ['None']}}\n"
    "\n"
    "3. Sentence: Vivian Peng implemented a new resource hub for safe injection sites in NY\n"
    "Output: {{'PERSON': ['Vivian Peng'], 'DATE': ['None'], 'LOC': ['NY'], 'ORG': ['None'], 'PROGRAMS': ['resource hub'], 'IMPACT': ['None']}}\n"
)
